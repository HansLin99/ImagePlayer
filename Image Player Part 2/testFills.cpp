...
#define CUSTOMX 120
#define CUSTOMY 75
#define CUSTOMTOLERANCE 0.008
#define CUSTOMTESTIMAGE "originals/mooncake.png"
#define CUSTOMFRAMEFREQ 50
#define CUSTOMSPACING 5
...
//    HSLAPixel px1(40., 1.0, 0.5);
//    HSLAPixel px2(0,0,0);
//
//    animation anim;
//    anim = filler::fillCustomDFS(img, CUSTOMX, CUSTOMY, px1, px2, CUSTOMSPACING, CUSTOMTOLERANCE, CUSTOMFRAMEFREQ);
...
//
//    animation anim;
//    anim = filler::fillCustomBFS(img, CUSTOMX, CUSTOMY, px1, px2, CUSTOMSPACING, CUSTOMTOLERANCE, CUSTOMFRAMEFREQ);
